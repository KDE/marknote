...
EditPage {
    ...
    titleDelegate: RowLayout {
        ...
        ToolButton {
            ...
            display: AbstractButton.IconOnly
            visible: !root.wideScreen && root.pageStack.columnView.columnResizeMode === Kirigami.ColumnView.SingleColumn
            checkable: true
        ...
        Item {
            Layout.preferredWidth: Kirigami.Units.largeSpacing * 9
            visible: !root.wideScreen && root.pageStack.columnView.columnResizeMode === Kirigami.ColumnView.SingleColumn
        }
        ...
        ToolButton {
            ...
            visible: root.wideScreen && root.pageStack.columnView.columnResizeMode === Kirigami.ColumnView.FixedColumns
